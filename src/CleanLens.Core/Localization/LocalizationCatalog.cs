    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Dictionaries =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Manual delete", ["ManualDeleteSelected"] = "Delete selected", ["ManualDeleteTitle"] = "Select folders for permanent deletion",
                ...
                ["ManualDeleteScanning"] = "Checking the registered install folder and matching locations in AppData, ProgramData and personal libraries. Nothing will change during this scan.",
                ["ManualDeleteCandidateCount"] = "{0} paths found · none selected",
                ["ManualDeleteEmpty"] = "No supported install, application-data or personal-library folders matched this app.",
                ["ManualDeleteSelectOne"] = "Select at least one path to continue.",
                ["ManualDeleteConfirm"] = "You selected {0} folder(s) for permanent deletion. This action cannot be undone. The app may have matched unrelated personal data. By continuing, you accept responsibility for every listed path.\n\n{1}\n\nDelete these folders permanently?",
                ...
                ["SafetyCheckManualDelete"] = "I understand Manual delete is permanent and can remove personal files. I will verify every path and accept responsibility for the folders I select.",
            ...
            ["it"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Eliminazione manuale", ["ManualDeleteSelected"] = "Elimina selezionate", ["ManualDeleteTitle"] = "Seleziona le cartelle da eliminare definitivamente",
                ...
                ["ManualDeleteScanning"] = "Controllo della cartella d'installazione registrata e dei percorsi corrispondenti in AppData, ProgramData e librerie personali. La scansione non modifica nulla.",
                ["ManualDeleteCandidateCount"] = "{0} percorsi trovati · nessuno selezionato",
                ["ManualDeleteEmpty"] = "Nessuna cartella d'installazione, dati app o libreria personale supportata corrisponde a questa app.",
                ["ManualDeleteSelectOne"] = "Seleziona almeno un percorso per continuare.",
                ["ManualDeleteConfirm"] = "Hai selezionato {0} cartelle da eliminare definitivamente. L'azione non si può annullare. L'app potrebbe aver trovato dati personali non correlati. Continuando, ti assumi la responsabilità di ogni percorso elencato.\n\n{1}\n\nEliminare definitivamente queste cartelle?",
                ...
                ["SafetyCheckManualDelete"] = "Ho capito che l'eliminazione manuale è definitiva e può rimuovere file personali. Verificherò ogni percorso e mi assumo la responsabilità delle cartelle selezionate.",
            ...
            ["es"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Eliminación manual", ["ManualDeleteSelected"] = "Eliminar selección", ["ManualDeleteTitle"] = "Seleccionar carpetas para eliminar permanentemente",
                ...
                ["ManualDeleteScanning"] = "Comprobando la carpeta de instalación registrada y las ubicaciones coincidentes en AppData, ProgramData y bibliotecas personales. Este análisis no modifica nada.",
                ["ManualDeleteCandidateCount"] = "{0} rutas encontradas · ninguna seleccionada",
                ["ManualDeleteEmpty"] = "No hay coincidencias en las carpetas de instalación, datos de aplicación o bibliotecas personales admitidas.",
                ["ManualDeleteSelectOne"] = "Selecciona al menos una ruta para continuar.",
                ["ManualDeleteConfirm"] = "Has seleccionado {0} carpeta(s) para eliminar permanentemente. No se puede deshacer. La aplicación podría haber encontrado datos personales ajenos. Al continuar, aceptas la responsabilidad de cada ruta indicada.\n\n{1}\n\n¿Eliminar estas carpetas permanentemente?",
                ...
                ["SafetyCheckManualDelete"] = "Entiendo que la eliminación manual es permanente y puede borrar archivos personales. Revisaré cada ruta y asumiré la responsabilidad de las carpetas que seleccione.",
            ...
            ["fr"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Suppression manuelle", ["ManualDeleteSelected"] = "Supprimer la sélection", ["ManualDeleteTitle"] = "Sélectionner les dossiers à supprimer définitivement",
                ...
                ["ManualDeleteScanning"] = "Vérification du dossier d'installation enregistré et des emplacements correspondants dans AppData, ProgramData et les bibliothèques personnelles. Cette analyse ne modifie rien.",
                ["ManualDeleteCandidateCount"] = "{0} chemins trouvés · aucun sélectionné",
                ["ManualDeleteEmpty"] = "Aucun dossier correspondant trouvé dans les emplacements d'installation, de données applicatives ou bibliothèques personnelles pris en charge.",
                ["ManualDeleteSelectOne"] = "Sélectionnez au moins un chemin pour continuer.",
                ["ManualDeleteConfirm"] = "Vous avez sélectionné {0} dossier(s) à supprimer définitivement. Cette action est irréversible. L'application peut avoir trouvé des données personnelles sans rapport. En continuant, vous assumez la responsabilité de chaque chemin indiqué.\n\n{1}\n\nSupprimer définitivement ces dossiers ?",
                ...
                ["SafetyCheckManualDelete"] = "Je comprends que la suppression manuelle est définitive et peut supprimer des fichiers personnels. Je vérifierai chaque chemin et assumerai la responsabilité des dossiers choisis.",
