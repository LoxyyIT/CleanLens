    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Dictionaries =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDeleteIntro"] = "CleanLens searches common personal folders up to three levels deep for exact folder-name matches. Every match is unselected. A matching name does not prove ownership; review each full path.",
            ...
            ["it"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDeleteIntro"] = "CleanLens cerca nelle cartelle personali più comuni, fino a tre livelli, nomi di cartella esatti. Nessun risultato è preselezionato. Un nome uguale non prova che la cartella appartenga all'app: controlla ogni percorso completo.",
            ...
            ["es"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDeleteIntro"] = "CleanLens busca coincidencias exactas hasta tres niveles dentro de las carpetas personales comunes. Ningún resultado está preseleccionado. Un nombre coincidente no demuestra que pertenezca a la aplicación; revisa cada ruta completa.",
            ...
            ["fr"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDeleteIntro"] = "CleanLens recherche des noms de dossiers exacts jusqu'à trois niveaux dans les dossiers personnels courants. Aucun résultat n'est présélectionné. Un nom identique ne prouve pas que le dossier appartient à l'application ; vérifiez chaque chemin complet.",
