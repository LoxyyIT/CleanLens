    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Dictionaries =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Manual delete", ["ManualDeleteTitle"] = "Select folders for permanent deletion",
                ["ManualDeleteIntro"] = "CleanLens searches all accessible subfolders in common personal folders for exact folder-name matches. Every match is unselected. A matching name does not prove ownership; review each full path.",
                ["ManualDeleteEmpty"] = "No exact folder-name matches were found in the supported personal folders.",
                ...
                ["Continue"] = "Continue", ["Cancel"] = "Cancel", ["SafetyRequired"] = "Accept the safety notice before starting an uninstaller.",
            ...
            ["it"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Eliminazione manuale", ["ManualDeleteTitle"] = "Seleziona le cartelle da eliminare definitivamente",
                ["ManualDeleteIntro"] = "CleanLens cerca nomi di cartella esatti in tutte le sottocartelle accessibili delle cartelle personali più comuni. Nessun risultato è preselezionato. Un nome uguale non prova che la cartella appartenga all'app: controlla ogni percorso completo.",
                ["ManualDeleteEmpty"] = "Nessuna cartella con nome esatto trovata nelle cartelle personali supportate.",
                ...
                ["Continue"] = "Continua", ["Cancel"] = "Annulla", ["SafetyRequired"] = "Accetta l'avviso di sicurezza prima di avviare un disinstallatore.",
            ...
            ["es"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Eliminación manual", ["ManualDeleteTitle"] = "Seleccionar carpetas para eliminar permanentemente",
                ["ManualDeleteIntro"] = "CleanLens busca nombres exactos en todas las subcarpetas accesibles de las carpetas personales comunes. Ningún resultado está preseleccionado. Un nombre coincidente no demuestra que pertenezca a la aplicación; revisa cada ruta completa.",
                ["ManualDeleteEmpty"] = "No se encontraron carpetas con nombres exactos en las carpetas personales admitidas.",
                ...
                ["Continue"] = "Continuar", ["Cancel"] = "Cancelar", ["SafetyRequired"] = "Acepta el aviso de seguridad antes de iniciar un desinstalador.",
            ...
            ["fr"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ManualDelete"] = "Suppression manuelle", ["ManualDeleteTitle"] = "Sélectionner les dossiers à supprimer définitivement",
                ["ManualDeleteIntro"] = "CleanLens recherche des noms de dossiers exacts dans tous les sous-dossiers accessibles des dossiers personnels courants. Aucun résultat n'est présélectionné. Un nom identique ne prouve pas que le dossier appartient à l'application ; vérifiez chaque chemin complet.",
                ["ManualDeleteEmpty"] = "Aucun dossier au nom exact trouvé dans les dossiers personnels pris en charge.",
                ...
                ["Continue"] = "Continuer", ["Cancel"] = "Annuler", ["SafetyRequired"] = "Acceptez l'avis de sécurité avant de lancer un désinstalleur.",
