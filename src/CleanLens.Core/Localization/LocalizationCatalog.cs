    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Dictionaries =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["EmptyQuarantineCopy"] = "Folders you move to quarantine will appear here with their original paths and restore option.",
                ...
                ["ManualDelete"] = "Manual delete", ["ManualDeleteSelected"] = "Delete selected", ["ManualDeleteTitle"] = "Select paths for permanent deletion",
                ["ManualDeleteIntro"] = "Review the full paths and match source. Every path starts unchecked. A registered install folder can contain program files; a name match does not prove ownership.",
                ["ManualDeleteScanning"] = "Checking registered and Windows Installer locations, Steam game metadata, AppData, ProgramData and personal libraries. Nothing will change during this scan.",
                ["ManualDeleteScanProgress"] = "{0} folders checked in supported locations…",
                ["ManualDeleteCandidateCount"] = "{0} paths found · none selected",
                ["ManualDeleteEmpty"] = "No app-specific paths were found in the supported install, Steam, app-data or personal-library locations. Some apps keep no removable data there.",
                ...
                ["ManualDeleteDone"] = "The selected folders were permanently deleted.",
                ...
                ["SafetyBody"] = "CleanLens can start a registered uninstaller, move application data and permanently delete folders you select. Inappropriate use or a wrong path can damage Windows, break software or remove personal files. Review every path and use manual deletion only when you accept the risk.",
            ...
            ["it"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["EmptyQuarantineCopy"] = "Le cartelle spostate in quarantena appariranno qui con il percorso originale e l'opzione di ripristino.",
                ...
                ["ManualDelete"] = "Eliminazione manuale", ["ManualDeleteSelected"] = "Elimina selezionate", ["ManualDeleteTitle"] = "Seleziona i percorsi da eliminare definitivamente",
                ["ManualDeleteIntro"] = "Controlla i percorsi completi e l'origine della corrispondenza. Nessun percorso è preselezionato. La cartella d'installazione registrata può contenere file del programma; un nome uguale non ne prova la proprietà.",
                ["ManualDeleteScanning"] = "Controllo dei percorsi registrati e di Windows Installer, dei dati di gioco Steam, di AppData, ProgramData e delle librerie personali. La scansione non modifica nulla.",
                ...
                ["ManualDeleteEmpty"] = "Nessun percorso specifico trovato nelle posizioni supportate di installazione, Steam, dati app o librerie personali. Alcune app non conservano dati rimovibili in queste posizioni.",
                ...
                ["ManualDeleteDone"] = "Le cartelle selezionate sono state eliminate definitivamente.",
                ...
                ["SafetyBody"] = "CleanLens può avviare un disinstallatore registrato, spostare dati applicativi ed eliminare definitivamente le cartelle selezionate. Un uso inappropriato o un percorso errato può danneggiare Windows, compromettere software o rimuovere file personali. Controlla ogni percorso e usa l'eliminazione manuale solo se accetti il rischio.",
            ...
            ["es"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["EmptyQuarantineCopy"] = "Las carpetas movidas a cuarentena aparecerán aquí con su ruta original y opción de restauración.",
                ...
                ["ManualDelete"] = "Eliminación manual", ["ManualDeleteSelected"] = "Eliminar selección", ["ManualDeleteTitle"] = "Seleccionar rutas para eliminar permanentemente",
                ["ManualDeleteIntro"] = "Revisa las rutas completas y el origen de cada coincidencia. Ninguna ruta está preseleccionada. La carpeta de instalación registrada puede contener archivos del programa; un nombre coincidente no demuestra que te pertenezca.",
                ["ManualDeleteScanning"] = "Comprobando ubicaciones registradas y de Windows Installer, datos de juegos de Steam, AppData, ProgramData y bibliotecas personales. Este análisis no modifica nada.",
                ...
                ["ManualDeleteEmpty"] = "No se encontraron rutas específicas en las ubicaciones admitidas de instalación, Steam, datos de aplicación o bibliotecas personales. Algunas aplicaciones no guardan datos eliminables allí.",
                ...
                ["ManualDeleteDone"] = "Se eliminaron permanentemente las carpetas seleccionadas.",
                ...
                ["SafetyBody"] = "CleanLens puede iniciar un desinstalador, mover datos y eliminar permanentemente las carpetas seleccionadas. El uso inadecuado o una ruta incorrecta puede dañar Windows, afectar al software o borrar archivos personales. Revisa cada ruta y usa la eliminación manual solo si aceptas el riesgo.",
            ...
            ["fr"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["EmptyQuarantineCopy"] = "Les dossiers déplacés en quarantaine apparaîtront ici avec leur chemin d'origine et l'option de restauration.",
                ...
                ["ManualDelete"] = "Suppression manuelle", ["ManualDeleteSelected"] = "Supprimer la sélection", ["ManualDeleteTitle"] = "Sélectionner les chemins à supprimer définitivement",
                ["ManualDeleteIntro"] = "Vérifiez les chemins complets et la source de chaque correspondance. Aucun chemin n'est présélectionné. Le dossier d'installation enregistré peut contenir des fichiers du programme ; un nom identique ne prouve pas son appartenance.",
                ["ManualDeleteScanning"] = "Vérification des emplacements enregistrés et Windows Installer, des données de jeux Steam, d'AppData, ProgramData et des bibliothèques personnelles. Cette analyse ne modifie rien.",
                ...
                ["ManualDeleteEmpty"] = "Aucun chemin spécifique trouvé dans les emplacements pris en charge d'installation, Steam, données applicatives ou bibliothèques personnelles. Certaines applications n'y conservent aucune donnée supprimable.",
                ...
                ["ManualDeleteDone"] = "Les dossiers sélectionnés ont été supprimés définitivement.",
                ...
                ["SafetyBody"] = "CleanLens peut lancer un désinstalleur, déplacer des données et supprimer définitivement les dossiers choisis. Un usage inapproprié ou un chemin erroné peut endommager Windows, perturber un logiciel ou supprimer des fichiers personnels. Vérifiez chaque chemin et n'utilisez la suppression manuelle que si vous acceptez le risque.",
